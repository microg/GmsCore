...
object AchievementsApiClient {
    ...
    suspend fun incrementAchievement(mContext: Context, oauthToken: String, achievementId: String, numSteps: Int) = requestGamesInfo(
        ...
        HashMap<String, String>().apply {
            ...
            put("stepsToIncrement", numSteps.toString())
        }).toIncrementResponse()
     ...
     */
    suspend fun updateMultipleAchievement(mContext: Context, oauthToken: String, list: ArrayList<Achievement>) = requestGamesInfo(
        mContext,
        Method.POST,
        oauthToken,
        "https://games.googleapis.com/games/v1/achievements/updateMultiple",
        null,
        list.toUpdateMultipleAchievements()
    ).toUpdateMultipleResponse()
