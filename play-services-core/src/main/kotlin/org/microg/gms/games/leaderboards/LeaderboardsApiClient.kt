...
object LeaderboardsApiClient {
     ...
     */
    suspend fun getLeaderboardById(mContext: Context, oauthToken: String, leaderboardId: String) = requestGamesInfo(
        mContext,
        Request.Method.GET,
        oauthToken,
     ...
     */
    suspend fun submitLeaderboardScores(mContext: Context, oauthToken: String, leaderboardId: String, score: String) =
        requestGamesInfo(mContext,
            Request.Method.POST,
            oauthToken,
