...
public class SnapshotMetadataEntity extends AbstractSafeParcelable implements SnapshotMetadata {
    ...
    public SnapshotMetadataEntity(SnapshotMetadata var1) {
        this(var1, new PlayerEntity(var1.getOwner()));
    }

    private SnapshotMetadataEntity(SnapshotMetadata var1, PlayerEntity var2) {
        this.gameEntity = new GameEntity(var1.getGame());
        this.playerEntity = var2;
        this.snapshotId = var1.getSnapshotId();
        this.coverImageUri = var1.getCoverImageUri();
        this.coverImageUrl = var1.getCoverImageUrl();
        this.coverImageAspectRatio = var1.getCoverImageAspectRatio();
        this.title = var1.getTitle();
        this.description = var1.getDescription();
        this.lastModifiedTimestamp = var1.getLastModifiedTimestamp();
        this.playedTime = var1.getPlayedTime();
        this.uniqueName = var1.getUniqueName();
