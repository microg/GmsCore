...
interface TileProvider {
     ...
     * @return the [Tile] to be used for this tile coordinate. If you do not wish to provide
     * a tile for this tile coordinate, return [.NO_TILE]. If the tile could not be found at
