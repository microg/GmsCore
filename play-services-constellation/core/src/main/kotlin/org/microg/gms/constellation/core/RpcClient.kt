...
object RpcClient {
    private val client: OkHttpClient = OkHttpClient.Builder()
        // Fix: GMS uses 60s timeouts across the board. OkHttp defaults are 10s.
        // Without matching these, we get SocketTimeoutException during SMS challenge
        // flows (Sync RPC, phone verification) - see #2994.
