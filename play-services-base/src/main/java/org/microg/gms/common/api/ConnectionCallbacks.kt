...
interface ConnectionCallbacks {
     ...
     *
     *
     * Note that the contents of the `connectionHint` Bundle are defined by the specific
     * services. Please see the documentation of the specific implementation of
     * [GoogleApiClient] you are using for more information.
     *
     ...
     * for a call to [.onConnected] to re-enable them.
     *
